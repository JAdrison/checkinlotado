...
const GallerySection = () => {
  return (
    <section className="py-20 px-7" style={{ background: "#EAE3CF" }}>
      <div className="max-w-[1100px] mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="reveal">
            ...
            <h2 className="font-heading text-[clamp(1.8rem,4vw,3rem)] font-normal text-night leading-[1.2] mb-5">
              De ponta a ponta do Brasil,{" "}
              <em className="shimmer-text font-bold">lotando fins de semana</em>
            </h2>
