  ...
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
      {phases.map((p, i) => (
        <div
          key={i}
          className={`landing-card reveal p-6 ${p.highlight ? "md:col-span-2 lg:col-span-2" : ""}`}
          style={{
        ...
        >
          ...
          <p className="text-night/55 text-[0.85rem] leading-relaxed mb-5" style={{ maxWidth: p.highlight ? 580 : undefined }}>
            {p.desc}
          </p>
